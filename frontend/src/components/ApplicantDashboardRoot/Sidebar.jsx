    ...
    <nav>
      <ul className="space-y-4 text-sm">
        <li className="border-b border-gray-200 pb-2">
          <NavLink to="/applicant/dashboard" end className={({ isActive }) =>`flex items-center text-gray-800 hover:text-white hover:bg-red-700 p-2 rounded ${isActive ? 'font-extrabold' : ''}`}>
        ...
        <li className="text-gray-700 border-b border-gray-200 pb-2">
          ...
          <ul className="pl-4 mt-2 border-l border-gray-200 ml-2">
            <li className="border-b border-gray-200 pb-2">
              <NavLink to="/applicant/dashboard/pending" className={({ isActive }) =>`flex items-center text-gray-600 hover:text-white hover:bg-red-700 p-2 rounded ${isActive ? 'font-extrabold' : ''}`}>
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="border-b border-gray-200 pb-2">
              <NavLink to="/applicant/dashboard/approved" className={({ isActive }) =>`flex items-center text-gray-600 hover:text-white hover:bg-red-700 p-2 rounded ${isActive ? 'font-extrabold' : ''}`}>
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="pb-2">
              <NavLink to="/applicant/dashboard/rejected" className={({ isActive }) =>`flex items-center text-gray-600 hover:text-white hover:bg-red-700 p-2 rounded ${isActive ? 'font-extrabold' : ''}`}>
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
