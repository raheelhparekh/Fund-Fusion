...
function ApplicantLogin({changeRole}) {
  ...
  return (
    <div className="flex bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
        <div className={`w-1/2 bg-red-700 p-12 flex flex-col justify-center ${animate ? 'slide-out-right' : 'fade-in-fwd'}`}>
        ...
        <div className={`w-1/2 p-12 flex flex-col justify-center ${animate ? 'text-blur-out' : 'fade-in-fwd'}`}>
          <h2 className="text-3xl font-bold mb-4">Login for Applicants<span role="img" aria-label="wave">👋</span></h2>
          <button 
